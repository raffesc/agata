...
include_once '../objects/category_appunti.php';
...
// initialize object
$appunti = new CategoryAppunti();
$appunti->setDB($db);


$appunti->id_project = $data->id_project;
$appunti->nome = $data->nome;

if (empty($appunti->id_project) || empty($appunti->nome) ) {
...
if ($appunti->insert()) {
    ...
    http_response_code(404);
    // show products data in json format
    echo json_encode(array("errore" => "Errore durante la creazione della categoria. Riprovare"));
