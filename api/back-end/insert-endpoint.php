...
if (empty($appunti->id_project) || empty($appunti->title) || empty($appunti->descrizione) ) {
...
if ($appunti->insert()) {
    ...
    http_response_code(404);
    // show products data in json format
    echo json_encode(array("errore" => "Errore durante la creazione dell'endpoint. Riprovare"));
